...
int edma3_memtomemcpytest_dma (int acnt, int bcnt, int ccnt, int sync_mode, int event_queue)
{
    ...
    dma_ch = result;
    DMA_PRINTK ("Alloc edma channel %d\n", dma_ch);
...
int edma3_memtomemcpytest_dma_link(int acnt, int bcnt, int ccnt, int sync_mode, int event_queue)
{
    ...
    edma_set_transfer_params (dma_ch1, acnt, bcnt, ccnt, BRCnt, sync_mode);
    ...
    dma_ch2 = result;
    DMA_PRINTK ("Alloc edma channel %d, slot %d\n", dma_ch1, dma_ch2);
    ...
    edma_set_transfer_params (dma_ch2, acnt, bcnt, ccnt, BRCnt, sync_mode);
...
int edma3_memtomemcpytest_dma_chain(int acnt, int bcnt, int ccnt, int sync_mode, int event_queue)
{
    ...
    dma_ch2 = result;
    DMA_PRINTK ("Alloc edma channel %d and %d\n", dma_ch1, dma_ch2);
    edma_set_src (dma_ch2, (unsigned long)(dmaphyssrc2), INCR, W8BIT);
    edma_set_dest (dma_ch2, (unsigned long)(dmaphysdest2), INCR, W8BIT);
    edma_set_src_index (dma_ch2, srcbidx, srccidx);
    edma_set_dest_index (dma_ch2, desbidx, descidx);
